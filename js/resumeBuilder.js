...
//formatted bio date, put in the top of resume page
function displaybio() {
	...
	formattedSkill1 =HTMLskills.replace("%data%", bio.skills[1]);
	formattedSkill2 =HTMLskills.replace("%data%", bio.skills[2]);
...
projects.display = function(){
	...
	var formattedProjectPic0=HTMLprojectImage.replace("%data%", projects.project[project].projectPic[0]);
	var formattedProjectPic1=HTMLprojectImage.replace("%data%", projects.project[project].projectPic[1]);
